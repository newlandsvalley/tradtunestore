...
(function(exports) {
  ...
  var elapsedTimeToBeat = function (skew) {
      return function (b) {
          return function (v) {
  ...
  var v1 = (function () {
                  var $12 = thisMeasure > 2.0 * duration;
                  if ($12) {
                      return new Data_Tuple.Tuple(2, (thisMeasure - 2.0 * duration) / duration);
                  };
                  var $13 = thisMeasure > duration - delta;
                  if ($13) {
                      return new Data_Tuple.Tuple(1, (thisMeasure - (duration - delta)) / (duration - delta));
                  };
                  return new Data_Tuple.Tuple(0, thisMeasure / duration);
              })();
              return {
                  number: v1.value0,
  ...
  var toBeats = function (skew) {
      return function (b) {
          return function (secs) {
              return Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(elapsedTimeToBeat(skew)(b))(secs);
          };
      };
  };
          ...
          return function (skew) {
              return function (beatMap) {
                  return function (v) {
                      ...
                      var v1 = Data_Map_Internal.lookup(Data_Ord.ordInt)(v.number)(beatMap);
                      if (v1 instanceof Data_Maybe.Just) {
                          return function __do() {
      ...
      return function (path) {
          return function (names) {
              return Control_Bind.bind(Effect_Aff.bindAff)(loadSoundBuffers(ctx)(path)(names))(function (v) {
                  var map0 = maybeInsert(Data_Ord.ordInt)(0)(Data_Array.index(v)(0))(Data_Map_Internal.empty);
                  var map1 = maybeInsert(Data_Ord.ordInt)(1)(Data_Array.index(v)(1))(map0);
                  var map2 = maybeInsert(Data_Ord.ordInt)(2)(Data_Array.index(v)(2))(map1);
 ...
 */  
      ...
      return function (beatNumber) {
          return function (skew) {
              return function (bpm) {
                  return function (v) {
                      if (isActive) {
                          return beatNumber === v.number && v.proportion < 0.2;
                      };
                      return false;
                  };
              };
  ...
  var circleForwardRotationRadius = 150.0;

  // | the radius of the rotation to get back on beat 2
  var circleBackRotationRadius = 2.0 * circleForwardRotationRadius;
  ...
  var movingCircle = function (skew) {
      return function (v) {
          var deltaRadius = skew * circleForwardRotationRadius;
          var radius = (function () {
              if (v.number === 2) {
                  return circleBackRotationRadius;
              };
              if (v.number === 1) {
                  return circleForwardRotationRadius + deltaRadius;
              };
              return circleForwardRotationRadius - deltaRadius;
          })();
  ...
  var deltaProportion = (skew * v.proportion * $$Math.pi) / 2.0;
          ...
          var centreX = (function () {
              if (v.number === 2) {
                  return leftMargin + circleBackRotationRadius;
              };
              if (v.number === 1) {
                  return (leftMargin + 3.0 * circleForwardRotationRadius) - deltaRadius;
              };
              return (leftMargin + circleForwardRotationRadius) - deltaRadius;
          })();
  ...
  var bigCircleRadius = smallCircleRadius + 3.0;
  ...
  var skewedBeat1Marker = function (skew) {
      return function (isCollided) {
          var delta = skew * circleForwardRotationRadius;
          var xPos = 2.0 * (circleForwardRotationRadius - delta) + leftMargin;
          return staticCircle(xPos)(isCollided);
      };
  };

  // beat markers 0 and 2 are fixed
  var beatMarker = function (beatNumber) {
      return function (isCollided) {
          var xPos = Data_Int.toNumber(beatNumber) * (2.0 * circleForwardRotationRadius) + leftMargin;
          return staticCircle(xPos)(isCollided);
      };
  };
          ...
          return function (skew) {
              return function (bpm) {
                  return function (beat) {
                      ...
                      if (beatNumber === 1) {
                          return skewedBeat1Marker(skew)(isCollided);
                      };
                      return beatMarker(beatNumber)(isCollided);
                  };
              };
          };
      };
  ...
  // | a collision
  var movingMarkers = function (isActive) {
      return function (skew) {
          return function (bpm) {
              return function (beat) {
                  return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(backdrop)(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(drawMarker(isActive)(0)(skew)(bpm)(beat))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(drawMarker(isActive)(1)(skew)(bpm)(beat))(drawMarker(isActive)(2)(skew)(bpm)(beat))));
              };
          };
      };
  };
  ...
  var markers = function (skew) {
      return movingMarkers(false)(skew)(120)(Metronome_Beat.beatStart);
  };

  // | Draw the active metronome at the particular beat in question.
  var metronome = function (skew) {
      return function (bpm) {
          return function (beat) {
              return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(movingMarkers(true)(skew)(bpm)(beat))(movingCircle(skew)(beat));
          };
      };
  };
...
(function(exports) {
  ...
  var ChangeTempo = (function () {
      function ChangeTempo(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeTempo.create = function (value0) {
          return function (value1) {
              return new ChangeTempo(value0, value1);
          };
      };
      return ChangeTempo;
  })();
  var ChangeSkew = (function () {
      function ChangeSkew(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeSkew.create = function (value0) {
          return function (value1) {
              return new ChangeSkew(value0, value1);
          };
      };
      return ChangeSkew;
  })();
          ...
          return function (dictMonadAff) {
              return Control_Bind.bind(dictBind)(Control_Monad_State_Class.get(dictMonadState))(function (v) {
                  ...
                  return Control_Bind.bind(dictBind)(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Effect_Timer.setTimeout(0)(v.runningMetronome)))(function (v1) {
                      return Control_Bind.bind(dictBind)(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Graphics_Drawing.render(graphicsCtx)(Metronome_Drawing.markers(v.skew))))(function (v2) {
                          return Control_Bind.bind(dictBind)(Control_Monad_State_Class.modify(dictMonadState)(function (st) {
                              ...
                              $33.isRunning = false;
                              $33.runningMetronome = Data_Monoid.mempty(Effect.monoidEffect(Data_Monoid.monoidUnit));
                              return $33;
                          }))(function (v3) {
  ...
  var renderTempoSlider = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("instruction-component") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("sliderLabel") ])([ Halogen_HTML_Core.text("change tempo:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(function ($66) {
          return Halogen_HTML_Events.input(ChangeTempo.create)(toTempo($66));
      }), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.id_("tempo-slider"), Halogen_HTML_Properties.min(60.0), Halogen_HTML_Properties.max(240.0), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(state.bpm)) ]) ]);
  };
  var renderStopStart = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("instruction-component") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(command)), Halogen_HTML_Properties.class_("hoverable") ])([ Halogen_HTML_Core.text(label) ]) ]);
  };
  var renderSkewSlider = function (state) {
      var toSkew = function (s) {
          return (50.0 - Global.readFloat(s)) / 100.0;
      };
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("instruction-component") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("sliderLabel") ])([ Halogen_HTML_Core.text("shorten 2nd beat:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(function ($67) {
          return Halogen_HTML_Events.input(ChangeSkew.create)(toSkew($67));
      }), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.id_("skew-slider"), Halogen_HTML_Properties.min(0.0), Halogen_HTML_Properties.max(50.0), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)((0.5 - state.skew) * 100.0)) ]) ]);
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Audio_WebAudio_BaseAudioContext.newAudioContext))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Metronome_Audio.loadBeatBuffers(v1)("assets/audio")([ "hightom.mp3", "tom.mp3", "hihat.mp3" ])))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $41.mAudioContext = new Data_Maybe.Just(v1);
                          $41.beatMap = v2;
                          return $41;
                      }))(function (v3) {
                          return $$eval(new Start(v.value0));
                      });
                  });
              });
          };
          if (v instanceof Start) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Graphics_Canvas.getCanvasElementById("canvas")))(function (v2) {
                      var canvas = Data_Maybe.fromJust()(v2);
                      var audioCtx = Data_Maybe.fromJust()(v1.mAudioContext);
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Graphics_Canvas.getContext2D(canvas)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(FRP_Behavior.animate(Metronome_Beat.toBeats(v1.skew)(v1.bpm)(FRP_Behavior_Time.seconds))(function (beat) {
                              return function __do() {
                                  var v4 = Graphics_Drawing.render(v3)(Metronome_Drawing.metronome(v1.skew)(v1.bpm)(beat))();
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $49.mGraphicsContext = new Data_Maybe.Just(v3);
                                  $49.isRunning = true;
                                  $49.runningMetronome = v4;
                                  return $49;
                              }))(function (v5) {
          ...
          if (v instanceof Stop) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(stopAnimation(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadStateHalogenM)(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff)))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof ChangeTempo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(stopAnimation(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadStateHalogenM)(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $55 = {};
                          for (var $56 in st) {
          ...
          throw new Error("Failed pattern match at Container line 89, column 3 - line 89, column 55: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bindFlipped(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(Container.component)(Data_Unit.unit)))(Halogen_Aff_Util.selectElement("#embed-ps-div"));
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
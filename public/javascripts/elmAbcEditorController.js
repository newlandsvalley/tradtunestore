...
var _newlandsvalley$elm_abc_player$MidiPerformance$addNoteToBarAccidentals = F2(
	function (n, accs) {
		...
		if (((_p3.ctor === '_Tuple2') && (_p3._0.ctor === 'Just')) && (_p3._1.ctor === 'Just')) {
			return A3(_newlandsvalley$elm_abc_player$Music_Accidentals$add, _p3._0._0, _p3._1._0, accs);
		} else {
			return accs;
		}
	});
...
var _newlandsvalley$elm_abc_player$MidiPerformance$midiChord = function (ns) {
	...
	var finalNoteOff = function () {
		...
		if (_p9.ctor === 'Just') {
			return _elm_lang$core$Native_List.fromArray(
				[
					_newlandsvalley$elm_abc_player$MidiPerformance$midiNoteOff(_p9._0)
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[]);

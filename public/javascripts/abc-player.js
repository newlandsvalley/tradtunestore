...
Elm.Music.Notation.make = function (_elm) {
   ...
   var chordalNoteDuration = F3(function (t,note,chord) {
      return 60.0 * $Ratio.toFloat(t.unitNoteLength) * $Ratio.toFloat(note) * $Ratio.toFloat(chord) / ($Ratio.toFloat(t.tempoNoteLength) * $Basics.toFloat(t.bpm));
   });
   var noteDuration = F2(function (t,n) {
      return 60.0 * $Ratio.toFloat(t.unitNoteLength) * $Ratio.toFloat(n) / ($Ratio.toFloat(t.tempoNoteLength) * $Basics.toFloat(t.bpm));
   });
   ...
   return _elm.Music.Notation.values = {_op: _op
                                       ...
                                       ,chordalNoteDuration: chordalNoteDuration
                                       ,AbcTempo: AbcTempo};
};
...
Elm.AbcPerformance.make = function (_elm) {
   ...
   var translateNoteSequence = F4(function (isSeq,
   state,
   notes,
   maybeChordDur) {
      ...
      var f = function (abc) {
         ...
         var duration = isSeq ? A2($Music$Notation.noteDuration,
         state.tempo,
         abc.duration) * state.tempoModifier : A3($Music$Notation.chordalNoteDuration,
         state.tempo,
         abc.duration,
         chordDuration) * state.tempoModifier;
   ...
   var addNoteEventToBarAccidentals = F2(function (ne,ks) {
      var _p3 = ne;
      if (_p3.ctor === "ANote") {
            return A2(addNoteToBarAccidentals,_p3._0,ks);
         } else {
            return A3($List.foldl,addNoteToBarAccidentals,ks,_p3._0);
         }
   });
   ...
   var updateState = F2(function (h,acc) {
      ...
      {case "UnitNoteLength": return {ctor: "_Tuple2"
                                     ,_0: melody
                                     ,_1: _U.update(state,
                                     {tempo: _U.update(tempo,{unitNoteLength: _p5._0})})};
         case "Tempo": var _p6 = _p5._0;
           ...
           return {ctor: "_Tuple2"
                  ,_0: melody
                  ,_1: _U.update(state,
                  {tempo: _U.update(tempo,{tempoNoteLength: tnl,bpm: _p6.bpm})})};
         case "Key": return {ctor: "_Tuple2"
                            ,_0: melody
                            ,_1: _U.update(state,{modifiedKeySignature: _p5._0})};
         default: return acc;}
   });
      ...
      if (isEmptyBar(lastBar)) {
            ...
            if (_p7.ctor === "_Tuple2" && _p7._0.ctor === "Just") {
                  if (_p7._0._0.ctor === "End" && _p7._1.ctor === "Just" && _p7._1._0.ctor === "Begin")
                  {
                        ...
                        "Just x",
                        _U.update(nextBar,
                        {repeat: $Maybe.Just(_p7._0._0),iteration: abcBar.iteration}));
                     }
               } else {
   ...
   var translateMusic = F2(function (m,acc) {
      ...
      var _p9 = m;
      switch (_p9.ctor)
      {case "Note": var _p10 = _p9._0;
           var barAccidentals = state.thisBar.accidentals;
           var duration = A2($Music$Notation.noteDuration,
           state.tempo,
           _p10.duration) * state.tempoModifier;
         ...
         case "Tuplet": var _p11 = _p9._0;
           ...
           return {ctor: "_Tuple2",_0: melodyLine,_1: newState};
         case "BrokenRhythmPair": var _p16 = _p9._2;
           var _p15 = _p9._0;
           var _p12 = _p9._1;
           if (_p12.ctor === "LeftArrow") {
                 ...
                 var _p14 = _p12._0;
                 var rightState = _U.update(state,
                 {tempoModifier: 1 - $Music$Notation.dotFactor(_p14)});
                 var leftState = _U.update(state,
                 {tempoModifier: 1 + $Music$Notation.dotFactor(_p14)});
                 var notePair = A4(translateNotePair,
                 _p15,
         ...
         case "Chord": var _p17 = _p9._0;
           var chord = A4(translateNoteSequence,
           false,
           state,
           _p17.notes,
           $Maybe.Just(_p17.duration));
         ...
         var repeatState = isEmptyBar(state.thisBar) ? state.repeatState : A2($Repeats.indexBar,
           ...
           var newBar = A3(buildNewBar,nextBarNumber,_p9._0,state.thisBar);
   ...
   var toMelodyLine = F2(function (ml,state) {
      var _p18 = A3($List.foldl,translateMusic,state,ml);
      var melody = _p18._0;
      var s = _p18._1;
   ...
   var fromAbc = function (tune) {
      var f = F2(function (bp,acc) {
         var _p19 = bp;
         if (_p19.ctor === "Score") {
               var _p20 = A2(toMelodyLine,_p19._0,acc);
               var newLine = _p20._0;
               ...
               return A2(updateState,_p19._0,acc);
            }
      });
      ...
      defaultState,
      $Basics.fst(tune));
      var _p22 = A3($List.foldl,f,headerState,$Basics.snd(tune));
      var music = _p22._0;
      var state = _p22._1;
   ...
   var melodyFromAbcResult = function (r) {
      ...
      function (_p23) {
         return $Repeats.buildRepeatedMelody(fromAbc(_p23));
      },
      r);
   };
...
Elm.SoundFont.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var getCurrentTime = function (ctx) {
      return $Native$SoundFont.getCurrentTime(ctx);
   };
   var maybePlay = F2(function (ctx,sb) {
      var _p0 = sb.mss;
      if (_p0.ctor === "Nothing") {
            return $Task.succeed({ctor: "_Tuple0"});
         } else {
            return A4($Native$SoundFont.play,
            ctx,
            _p0._0.buffer,
            getCurrentTime(ctx) + sb.time,
            sb.gain);
         }
   });
   var loadSoundFont = F2(function (ctx,name) {
      return A2($Native$SoundFont.loadSoundFont,ctx,name);
   });
   var getAudioContext = function (_p1) {
      return $Native$SoundFont.getAudioContext({ctor: "_Tuple0"});
   };
   var isWebAudioEnabled = $Native$SoundFont.isWebAudioEnabled({ctor: "_Tuple0"});
...
Elm.Notable.make = function (_elm) {
   ...
   var fromMelodyLine = F2(function (t,m) {
      ...
      fromBar,
      {ctor: "_Tuple3",_0: 2.5e-2,_1: $Maybe.Nothing,_2: _U.list([])},
      m);
      var t = _p5._0;
      var mtie = _p5._1;
      var p = _p5._2;
...
Elm.Lessons.make = function (_elm) {
   ...
   var xmplChords = "| A2 Bc dcBc | [CEa] GB [BGD]3 BG |";
   var instChords = A2($Basics._op["++"],
   ...
   var hintShortNotes = "Try experimenting with a succession of notes of different pitch and with different fractional values.";
...
Elm.AbcTutorial.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var pianoFonts = A2($SoundFont.loadSoundFont,
   $SoundFont.getAudioContext({ctor: "_Tuple0"}),
   ...
   var nextSound = F3(function (ctx,samples,ne) {
      var _p9 = ne;
      var time = _p9._0;
      var notable = _p9._1;
      var _p10 = notable;
      ...
      return A2($SoundFont.maybePlay,ctx,soundBite);
   });
   var makeSounds = F3(function (mctx,ss,perfResult) {
      var _p11 = perfResult;
      if (_p11.ctor === "Ok") {
            var _p12 = mctx;
            if (_p12.ctor === "Just") {
                  return A2($List.map,A2(nextSound,_p12._0,ss),_p11._0);
               } else {
                  return _U.list([]);
               }
         } else {
   ...
   var finaliseAudioContext = function (m) {
      var ctx = $SoundFont.isWebAudioEnabled ? $Maybe.Just($SoundFont.getAudioContext({ctor: "_Tuple0"})) : $Maybe.Nothing;
      return _U.update(m,{maybeContext: ctx,loaded: true});
   };
   ...
   var checkAudio = $SoundFont.isWebAudioEnabled ? $Effects.task(showButtons) : $Effects.none;
   var Play = {ctor: "Play"};
   var Abc = function (a) {    return {ctor: "Abc",_0: a};};
   var view = F2(function (address,model) {
      return $SoundFont.isWebAudioEnabled ? A2($Html.div,
      _U.list([centreStyle]),
      _U.list([A2($Html.h1,
              _U.list([]),
              ...
              _U.list([A2($Html.p,
                      ...
                      ,A2($Html.p,
                      _U.list([]),
                      _U.list([$Html.text(viewError(model.error))]))]))])) : A2($Html.div,
      _U.list([centreStyle]),
      _U.list([A2($Html.p,
      _U.list([]),
      _U.list([$Html.text("It seems as if your browser does not support web-audio.  Perhaps try Chrome")]))]));
   });
   var LoadFont = function (a) {
      return {ctor: "LoadFont",_0: a};
   };
   var signals = $SoundFont.isWebAudioEnabled ? _U.list([A2($Signal.map,
   LoadFont,
   pianoFonts)]) : _U.list([]);
   var NoOp = {ctor: "NoOp"};
   ...
   var playAbc = function (m) {
      ...
      var _p16 = pr;
      if (_p16.ctor === "Ok") {
            return A2(playSounds,
            pr,
            A3(makeSounds,m.maybeContext,m.samples,pr));
         } else {
            return returnError(_p16._0);
         }
   };
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
         ...
         case "ShowButtons": return {ctor: "_Tuple2"
                                    ...
                                    ,_1: $Effects.none};
         case "LoadFont": var _p18 = _p17._0;
           if (_p18.ctor === "Nothing") {
                 ...
                 if (_p19 === "end") {
                       return {ctor: "_Tuple2"
                              ,_0: finaliseAudioContext(model)
                              ,_1: checkAudio};
                    } else {
                       var pitch = toInt(_p20.name);
                       return {ctor: "_Tuple2"
                              ,_0: _U.update(model,
                              {samples: A3($Dict.insert,pitch,_p20,model.samples)})
                              ,_1: $Effects.none};
                    }
              }
         case "Abc": return {ctor: "_Tuple2"
                            ,_0: _U.update(model,{abc: _p17._0})
                            ,_1: $Effects.none};
         ...
         case "MoveToEnd": var next = function () {
           ...
           return {ctor: "_Tuple2"
                  ...
                  ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,{error: $Maybe.Just(_p17._0)})
   ...
   return _elm.AbcTutorial.values = {_op: _op
                                    ...
                                    ,Error: Error
                                    ,update: update
                                    ,finaliseAudioContext: finaliseAudioContext
                                    ,nextSound: nextSound
